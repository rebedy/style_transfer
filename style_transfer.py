...
def build_parser():
    ...
    parser.add_argument('--total-variation-weight', type=float, default=1e2,
                        dest='total-variation-weight', help='total variation regularization weight (default %(default)s)')
...
class StyleTrasfer:
	...
	def style_transfer(self):
		...
		if initial is not None:
			initial = scipy.misc.imresize(self.img_read(initial), content_image.shape[:2])
